...
3. Essencialismo x nominalismo
4. Objetividade x subjetividade
5. As flores japonesas

--

# 1. Polêmicas
## Passando o mais rápido possível
...
- se os cientistas são dogmáticos também (kuhn), o que tornaria a psicanálise alvo de críticas especiais?
  - influente demais
  - fácil de atacar (dogmática)
  - se defende mal (extraterritorialidade)
  - nada acontece
  - todo mundo publica seu livro!
...
- popper diz que a racionalidade é uma /obrigação moral/. só se é obrigado a coisas que não acontecem sozinhas. 
   ...
   - ele assume que o pensamento mágico é uma distorção do pensamento normal, "racional".
   - essa história dos "vieses" e das "heurísticas"

--

### Questão de pseudociência

- Para popper, a ciencia é sobre democracia e evitar discursos autoritários. É uma questão pública.
  - a ciência não produz pessoas automaticamente mais virtuosas.
  - Para Pilati, é uma questão privada: 'um exercicio de humildade e formacao de carater' (p. 20).
    - Pilati age como se o pensamento científico nos colocasse 'em maior contato com a nossa humanidade' (Rorty, CP).
  - O objetivo deles é evitar a política por meio de uma relação direta entre epistemologia e moral. 
...
- A confusão entre normas e leis.
...
“Fundamentação”
- Fundamentar sua decisão em fatos
- Fundamentar seu direito na Bíblia
- Fundamentar sua terapia nas Condições de Possibilidade da Existência
- Fundamentar sua análise na Estrutura Topológica do Sujeito
...
- o conforto de alguém decidir por você
- Tsing eua x china
- pbe!
...
- a lei universal, a chave mestra
...
- De onde eles partem – conhecimento situado, ou
...
- não precisa ser sobrenatural, essencial
- não precisa ser um objeto, ou causa 
- não precisa ser "inefável" ou "ontologicamente negativo"
- não precisa ser um enigma meio-dito
- todas essas coisas vem das perguntas que o essencialismo permite
  - existe alternativa
...
- romântica, profunda, interior
- se não há uma, não pode haver a outra
...
### Verdade revelada & conspiracionismo
...
- antiautoritário
  - o paciente tem acesso a uma verdade que não é imposta
- autoritário
  - depende de uma verdade revelada
    - verdade revelada gera conspiração
      - "está resistindo"
      - "tem que fazer mais análise"
      - irrefutável
...
- Lacan inventou que deve-se usar um vocabulário epistemológico
  - um enquadre arbitrário para uma psicoterapia
  - focada nas Origens da Verdade
...
- Contrastando com a Verdade do Real.
  - que seria verdadeira por ser irrefutável
...
> **E é significativo que possamos distinguir entre a crítica de uma mera _formulação_ de um pensamento – um pensamento pode ser bem formulado, ou não tão bem – e os aspectos lógicos do pensamento em si; sua verdade;**
...
- "Transmissão"
  - a verdade freudiana não pode ser comunicada - ela é “transmitida”
  - deve ser uma vivência. uma intuição
    - ou seja, não pode sair do mundo 2
  - não passa pelo mundo 3
    - pela linguagem
    - pela teoria
    - pela objetividade
    - pela crítica
...
- “a ciencia forclui o sujeito”.
  - formular a Verdade no mundo 3 perde o encantamento.
  - a sensação de verdade (o efeito-autor)
- Só coisas no mundo 3 podem ser criticadas.
  - No mundo 2 as sensações sempre se verificam.
  - No mundo 2 não há riscos
  - A responsabilidade é sempre do outro de captar a transmissão

--
# 6. As flores japonesas
<br/> <br/>
![](img/lotus.jpg)
--
...
- "Espere daqui 7 anos..." (historicismo)
- "As bruxas do tiktok são fracas" (autoridade)
- "Ele é um bruxo secreto" (conspiração)
- ~~magia não funciona~~
